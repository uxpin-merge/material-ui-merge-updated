    ...
    return (
      <div style={containerStyles}>
        ...
        >
          ...
          <button onClick={this.toggleFixed} style={styles.button}>Full screen</button>
          <button onClick={this.toggleFormPosition} style={styles.button}>Toggle</button>
        </form>
        <Frame style={frameStyle} head={documentHead()}><IFramePlayground width="100%" >{this.props.children}</IFramePlayground></Frame>
